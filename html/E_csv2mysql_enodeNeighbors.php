...
$sql = "TRUNCATE TABLE e_enodeb_neighbors";
...
$message = null;
		...
		if ((  $handle =  fopen("/var/www/html/documents/E_Totals_clean.csv", "r"))!== false){
			
			$db = getPDO('WestAreaSystemPerformance');
			$db->exec("SET CHARACTER SET utf8");
			
			$headers = fgetcsv($handle); //get headers
			$SQLtext = "INSERT IGNORE INTO e_enodeb_neighbors SET ";
...
header("Location: https://irvecaqg-wadtr-vm20.nss.vzwnet.com/E_process.php");	
