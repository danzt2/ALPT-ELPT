...
$client->GET("http://elpt.vh.eng.vzwcorp.com:8181/elte/reportWebService.htm?action=exectmpl&tmpl_rpt=c0thd15|||ROI Neighbors&user=c0thd15&name=ROI_NEIGHBORS&edate=$edate&enodeb=$enodeb");

open my $out, ">", $rcnt."Neighbors_E.csv" or die $!;
...
print $enodeb "\n";
  ...
  close IN_H;
 system("mv *Neighbors_E.csv documents/.");
print "\n Done!\n";