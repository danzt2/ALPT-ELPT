...
$message = null;
		if ((  $handle =  fopen("/var/www/html/ROI_Report_Clean.csv", "r"))!== false){
			
			$db = getPDO('WestAreaSystemPerformance');
			$db->exec("SET CHARACTER SET utf8");			
			$headers = fgetcsv($handle); //get headers
			$SQLtext = "INSERT IGNORE INTO roi_report SET ";
...
header("Location: https://irvecaqg-wadtr-vm20.nss.vzwnet.com/query/populate_neighbor_performance.php");				
